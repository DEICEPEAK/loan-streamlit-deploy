...
def make_prediction(_model, _scaler, _col_name, X_pred):
    ...
    return f'There is a {default_proba * 100:.2f}% probability that this applicant with given details  will default.'

if __name__ == '__main__':
    st.title('LOAN DEFAULT PREDICTION')
    st.write("This app will predict the probability of a loan applicant defaulting on their loan repayment.")
    st.image("lpic2.jpg")
